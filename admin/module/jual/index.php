						...
						<table class="table table-stripped">
								...
								if(!empty($bayar))
								{
									...
									if($bayar >= $total)
									{
										...
										for($x=0;$x<$jumlah_dipilih;$x++){
											...
											$row_barang = $conn->prepare($sql_barang);
											...
											$row_stok = $conn->prepare($sql_stok);
							...
							<form method="POST" action="index.php?page=jual&nota=yes#kasirnya">
								...
								<tr>
									...
									<td>Bayar  </td>
									<td><input type="text" class="form-control" name="bayar" value="<?php $bayar;?>"></td>
									<td><button class="btn btn-success"><i class="fa fa-shopping-cart"></i> Bayar</button>
									<?php  if(!empty(isset($_GET['nota']) == 'yes')) {?>
							...
							<tr>
								<td>Kembali</td>
								<td><input type="text" class="form-control" value="<?php $hitung;?>"></td>
								<td></td>
								<td>
